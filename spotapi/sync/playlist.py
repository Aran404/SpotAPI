...
class PublicPlaylist:
    ...
    def paginate_playlist(self) -> Generator[Mapping[str, Any], None, None]:
        ...
        while offset < total_count:
            yield self.get_playlist_info(limit=UPPER_LIMIT, offset=offset)["data"]["playlistV2"][
                "content"
            ]
            offset += UPPER_LIMIT
...
class PrivatePlaylist:
    ...
    def paginate_saved_tracks(self) -> Generator[Mapping[str, Any], None, None]:
        ...
        offset = UPPER_LIMIT
        while offset < total_count:
            yield self.get_saved_tracks_info(limit=UPPER_LIMIT, offset=offset)["data"]["me"][
                "library"
            ]["tracks"]
            offset += UPPER_LIMIT

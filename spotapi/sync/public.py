...
from spotapi.sync.client import TLSClient
...
class Pooler(Generic[T]):
    ...
    def __init__(self, factory: Callable[..., T], *, max_cache: int | None = None) -> None:
...
client_pool: Pooler[TLSClient] = Pooler(factory=lambda: TLSClient("chrome120", "", auto_retries=3))

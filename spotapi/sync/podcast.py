...
from spotapi.sync.exceptions import PodcastError
...
class Podcast:
    ...
    def __init__(
        ...
        *,
        ...
        if podcast:
            self.podcast_id = podcast.split("show/")[-1] if "show" in podcast else podcast
    ...
    def get_podcast_info(self, limit: int = 25, *, offset: int = 0) -> Mapping[str, Any]:

...
from spotapi.sync.types.interfaces import SaverProtocol
from spotapi.sync.exceptions import SaverError
                ...
                with open(self.path, "r") as f:
                    ...
                    if current:
                        current = [
                            item
                            for item in current
                            if not any(item["identifier"] == d["identifier"] for d in data)
                        ]

...
from spotapi.sync.types.interfaces import CaptchaProtocol, LoggerProtocol
...
class AudioOutputDeviceInfo:
    ...
    def from_dict(data: Dict[str, Any]) -> "AudioOutputDeviceInfo":
        valid_keys = {
            key: data[key] for key in AudioOutputDeviceInfo.__annotations__.keys() if key in data
        }

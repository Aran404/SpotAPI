import time
import uuid
from spotapi.sync.utils.strings import parse_json_string
from spotapi.sync.types.annotations import enforce
from spotapi.sync.exceptions import PasswordError
from spotapi.sync.types.data import Config
...
class Password:
    ...
    def reset(self) -> None:
        ...
        self.logger.info("Successfully reset password", time_taken=f"{int(time.time() - now)}s")

...
from spotapi.sync.exceptions import ParentException, RequestError
...
class TLSClient(Session):
    ...
    def post(
        ...
        **kwargs,
        ...
        return self._send("POST", url, authenticate=authenticate, danger=danger, **kwargs)
    ...
    def put(
        ...
        **kwargs,
        ...
        return self._send("PUT", url, authenticate=authenticate, danger=danger, **kwargs)

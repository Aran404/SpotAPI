...
import json
from spotapi.sync.types.annotations import enforce
from typing import Any, Literal
from collections.abc import Mapping, Generator
from spotapi.sync.client import BaseClient
from spotapi.sync.exceptions import ArtistError
from spotapi.sync.http.request import TLSClient
from spotapi.sync.login import Login
from spotapi.sync.client import BaseClient
...
class Artist:
    ...
    def __init__(
        ...
        *,
        ...
        self.base = BaseClient(
            client=login.client if (login is not None) else client, language=language
        )
    ...
    def paginate_artists(self, query: str, /) -> Generator[Mapping[str, Any], None, None]:
        ...
        while offset < total_count:
            yield self.query_artists(query, limit=UPPER_LIMIT, offset=offset)["data"]["searchV2"][
                "artists"
            ]["items"]
            offset += UPPER_LIMIT
    ...
    def get_artist_discography(
        ...
        *,
        ...
        if resp.fail:
            raise ArtistError("Could not get artist discography", error=resp.error.string)
    ...
    def paginate_artist_discography(
        ...
        *,
        ...
        section_data = (
            first.get("data", {}).get("artistUnion", {}).get("discography", {}).get(section, {})
        )

...
from spotapi.v2.datastruct import EventDispatcher

if TYPE_CHECKING:
    from typing import Unpack
    from spotapi.v2.connection.http import HTTPClient
...
class WebSocketClient:
    ...
    async def connect(
        ...
        **kwargs: Unpack[wreq.WebSocketRequest],
        ...
        async with ws:
            self._ws = ws
            self._recv_task = asyncio.create_task(self._receive_loop(), name=f"ws-recv:{url}")
            try:
